...
ActiveRecord::Schema[7.0].define(version: 2023_07_09_175848) do
  ...
  create_table "bank_transitions", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.bigint "origin_id"
    t.index ["origin_id"], name: "index_bank_transitions_on_origin_id"
  end
  ...
  create_table "user_wallets", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["user_id", "wallet_id"], name: "index_user_wallets_on_user_id_and_wallet_id", unique: true
  ...
  create_table "variable_incomes", force: :cascade do |t|
    t.string "mode"
    t.string "name"
    t.bigint "value"
    t.date "trade_date"
